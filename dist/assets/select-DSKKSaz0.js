import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, ah as composeRefs, ai as createContextScope, $ as $1CM7W$react, aj as useComposedRefs, k as reactDomExports, ak as useEscapeKeydown, al as composeEventHandlers, am as useCallbackRef, an as useSize, ao as useFloating, ap as offset, aq as shift, ar as flip, as as size, at as arrow, au as hide, av as limitShift, aw as autoUpdate, ax as useLayoutEffect2, ay as $1CM7W$reactdom, az as useControllableState, aA as useId, aB as VisuallyHidden, aC as hideOthers, aD as useFocusGuards, aE as ReactRemoveScroll, z as cn } from './index-BxW4NEkE.js';
import { a as ChevronDown, C as ChevronUp } from './chevron-up-wBRuSHft.js';
...
function createCollection(name) {
  ...
  const CollectionProvider = (props) => {
    ...
    const ref = $1CM7W$react.useRef(null);
    const itemMap = $1CM7W$react.useRef(/* @__PURE__ */ new Map()).current;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CollectionProviderImpl, { scope, itemMap, collectionRef: ref, children });
  };
  CollectionProvider.displayName = PROVIDER_NAME;
  const COLLECTION_SLOT_NAME = name + "CollectionSlot";
  const CollectionSlot = $1CM7W$react.forwardRef(
    (props, forwardedRef) => {
      const { scope, children } = props;
  ...
  const CollectionItemSlot = $1CM7W$react.forwardRef(
    (props, forwardedRef) => {
      const { scope, children, ...itemData } = props;
      const ref = $1CM7W$react.useRef(null);
      const composedRefs = useComposedRefs(forwardedRef, ref);
      const context = useCollectionContext(ITEM_SLOT_NAME, scope);
      $1CM7W$react.useEffect(() => {
  ...
  function useCollection(scope) {
    ...
    const getItems = $1CM7W$react.useCallback(() => {
...
var Portal$1 = reactExports.forwardRef((props, forwardedRef) => {
  ...
  return container ? $1CM7W$reactdom.createPortal(/* @__PURE__ */ jsxRuntimeExports.jsx(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
export { Check as C, Select as S, SelectTrigger as a, SelectValue as b, SelectContent as c, SelectItem as d, SelectGroup as e };
